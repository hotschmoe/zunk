...
pub fn onKeyDown(func: bind.CallbackFn) void {
    zunk_input_set_key_callback(bind.registerCallback(func));
}

pub fn onMouseMove(func: bind.CallbackFn) void {
    zunk_input_set_mouse_callback(bind.registerCallback(func));
}

pub fn onTouch(func: bind.CallbackFn) void {
    zunk_input_set_touch_callback(bind.registerCallback(func));
}
